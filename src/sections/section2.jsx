            ...
            <section>
                <div className="w-full max-w-7xl mx-auto px-6 md:px-4  undefined">
                    <div className="flex flex-col justify-center md:text-center text-[28px] md:text-[40px] leading-[34px] md:leading-[1.2] tx-black-primary md:pb-16 font-medium">
                        ...
                        <p style={{opacity: 1, transform: 'none'}}><span className="text-[#9EA7AE] ">round the clock </span>Whatsapp support. <span className="text-[#9EA7AE] ">And it's</span></p>
                        <p style={{opacity: 1, transform: 'none'}}>lifetime free<span style={{ fontWeight: 400, color: '#9ea7ae' }}>; no joining fee, no annual charges.</span></p>
                    </div>
